...
@ТипШага: Тест поля Количество (итог) документа Заказ
@Описание: Экспортный сценарий проверка корректности расчета поля Количество (итог) документа Заказ
@ПримерИспользования: И выполняю тест проверка корректности расчета поля Количество (итог) документа Заказ
Сценарий: выполняю тест проверки корректности расчета поля Количество (итог) документа Заказ
